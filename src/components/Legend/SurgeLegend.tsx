...
export function SurgeLegend() {
  return (
    <div className="bg-slate-900/80 border border-orange-500/30 rounded-lg p-4 text-slate-100 shadow-lg">
      <h3 className="text-sm font-medium text-orange-300 mb-3">Surge Intensity</h3>
